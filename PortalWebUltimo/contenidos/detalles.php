...
<table class="clasetabla">
	...
	<tr>
		<td colspan="2" class="estilocelda6">
            Precio neto: $  <?php echo round($fila[Precio]/(1.19)); ?>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="estilocelda6">
            Precio iva incluido: $ <?php echo $fila[Precio]; ?>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="estiloceldaF">
			<a href="agregar.php?<?php echo SID ?>&id=<?php echo $fila['ProductoID']; ?>"><img src="imagenes/sitio/comp_normal.gif"></a>
        </td>
	</tr>
	<tr>
